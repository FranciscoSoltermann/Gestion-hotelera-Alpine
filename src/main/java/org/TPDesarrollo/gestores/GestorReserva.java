...
// 1. Relación con Reserva (Ya la tenías)

                        ocupante.setReserva(reservaAProcesar);



// 2. Relación con Habitación (ESTA ES LA QUE TE FALTA)

                        ocupante.setHabitacion(h); // <--- AGREGA ESTO

// 'h' es la variable del bucle "for (Habitacion h : habitaciones)"
